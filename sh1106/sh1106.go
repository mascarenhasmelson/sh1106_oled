...
// Each command and its parameter(s) are sent in a single WriteCmd call so the
// I2C control byte (0x00) is not inserted between a command and its argument.
func (d *Device) Init() error {
	cmds := [][]byte{
		{cmdDisplayOff},
		{cmdSetDisplayClock, 0x80},            // clock divide ratio / oscillator freq
		{cmdSetMultiplex, byte(d.height - 1)}, // multiplex ratio
		{cmdSetDisplayOffset, 0x00},            // no vertical offset
		{cmdSetStartLine | 0x00},               // start line 0
		{cmdChargePump, 0x14},                  // enable internal charge pump
		{cmdSetSegmentRemap1},                  // column 127 mapped to SEG0
		{cmdSetComScanDec},                     // scan from COM[N-1] to COM0
		{cmdSetComPins, comPinsFor(d.height)},  // COM pins hardware config
		{cmdSetContrast, 0xCF},                 // contrast
		{cmdSetPrecharge, 0xF1},                // pre-charge period
		{cmdSetVcomDetect, 0x40},               // VCOM deselect level
		{cmdSetEntireDisplayOn},                // 0xA4 — output follows RAM
		{cmdSetNormalDisplay},
		{cmdDisplayOn},
	}
	for _, c := range cmds {
...
// Verified against the Adafruit GFX / SSD1306 standard font — the most
// widely tested 5×8 bitmap set for small OLED displays.
var font5x8 = [95][5]byte{
	...
	{0x00, 0x60, 0x60, 0x60, 0x00}, // '.' 0x2E  — 3 cols wide
	{0x60, 0x30, 0x18, 0x0C, 0x06}, // '/' 0x2F  — thick diagonal
	{0x3E, 0x41, 0x41, 0x41, 0x3E}, // '0' 0x30  — clean oval
	{0x00, 0x42, 0x7F, 0x40, 0x00}, // '1' 0x31
	{0x62, 0x51, 0x49, 0x49, 0x46}, // '2' 0x32
	{0x22, 0x41, 0x49, 0x49, 0x36}, // '3' 0x33
	{0x18, 0x14, 0x12, 0x7F, 0x10}, // '4' 0x34
	{0x4F, 0x49, 0x49, 0x49, 0x31}, // '5' 0x35
	{0x3E, 0x49, 0x49, 0x49, 0x32}, // '6' 0x36
	{0x01, 0x01, 0x71, 0x09, 0x07}, // '7' 0x37
	{0x36, 0x49, 0x49, 0x49, 0x36}, // '8' 0x38
	{0x26, 0x49, 0x49, 0x49, 0x3E}, // '9' 0x39
	{0x00, 0x36, 0x36, 0x36, 0x00}, // ':' 0x3A  — 3 cols wide
	...
	{0x00, 0x41, 0x7F, 0x41, 0x00}, // 'I' 0x49  — 3-wide serifs (was 5-wide, looked like ═)
	{0x20, 0x40, 0x41, 0x3F, 0x01}, // 'J' 0x4A
	{0x7F, 0x08, 0x14, 0x22, 0x41}, // 'K' 0x4B
	{0x7F, 0x40, 0x40, 0x40, 0x40}, // 'L' 0x4C
	{0x7F, 0x02, 0x0C, 0x02, 0x7F}, // 'M' 0x4D  — correct V-notch (was too flat)
	{0x7F, 0x04, 0x08, 0x10, 0x7F}, // 'N' 0x4E  — correct diagonal (was shifted)
	{0x3E, 0x41, 0x41, 0x41, 0x3E}, // 'O' 0x4F
	{0x7F, 0x09, 0x09, 0x09, 0x06}, // 'P' 0x50
	{0x3E, 0x41, 0x51, 0x21, 0x5E}, // 'Q' 0x51
	{0x7F, 0x09, 0x19, 0x29, 0x46}, // 'R' 0x52  — leg fans out correctly (was straight down like P)
	{0x46, 0x49, 0x49, 0x49, 0x31}, // 'S' 0x53  — correct curves (was mirrored wrong)
